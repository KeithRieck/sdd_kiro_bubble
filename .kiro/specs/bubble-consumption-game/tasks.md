...
This implementation plan breaks down the bubble consumption game into discrete coding tasks. The game is built with JavaScript ES2020 and Phaser 3, following a client-side only architecture. The visual design features a dark gray screen background (#808080) with a black Game_World area (#000000) where gameplay occurs. The HUD displays score and lives outside the Game_World in 24-point Arial/Helvetica font. AI bubbles spawn at least 200 pixels away from the player. When scenarios restart (from winning or losing a life), the game pauses for 2 seconds and resets the player bubble size to 30 pixels. Implementation proceeds incrementally: project setup → core entities → game systems → scene orchestration → PWA features → testing.
...
- [x] 2. Implement abstract Bubble base class
  ...
  - [x] 2.2 Write property test for boundary constraint
...
- [x] 3. Implement PlayerBubble class
  ...
  - [x] 3.2 Write property test for speed calculation
  ...
  - [x] 3.4 Write property test for input target setting
  ...
  - [x] 3.7 Write property test for growth calculation
...
- [x] 4. Implement AIBubble class
  ...
  - [x] 4.3 Write property test for boundary bouncing
    - **Property 11: AI Bubble Boundary Bouncing**
    - **Validates: Requirements 4.3**
  
  - [x] 4.4 Write property test for constant velocity
...
- [x] 5. Implement CollisionSystem
  ...
  - [x] 5.2 Write property test for collision detection
    - **Property 4: Collision Detection by Distance**
    - **Validates: Requirements 10.1, 10.2, 10.3**
  
  - [x] 5.3 Write property test for consumption score increase
    - **Property 5: Consumption Increases Score**
    - **Validates: Requirements 3.2, 6.4**
  
  - [x] 5.4 Write property test for area conservation
    - **Property 7: Area Conservation**
    - **Validates: Requirements 3.5**
  
  - [x] 5.5 Write property test for death on larger collision
...
- [x] 7. Implement SpawnSystem
  ...
  - [x] 7.3 Write property test for AI bubble size range
    - **Property 15: AI Bubble Size Range**
    - **Validates: Requirements 4.4, 5.3**
  
  - [x] 7.4 Write property test for dynamic size scaling
  ...
  - [x] 7.6 Write property test for smaller bubble distribution
    - **Property 17: Smaller Bubble Distribution**
    - **Validates: Requirements 11.3**
  
  - [x] 7.7 Write property test for larger bubble distribution
  ...
  - [x] 7.9 Write property test for spawn distance from player
    - **Property 28: AI Bubble Spawn Distance from Player**
    - **Validates: Requirements 4.2**
  
  - [x] 7.10 Write property test for spawn position within bounds
...
- [x] 8. Implement HUD class
  ...
  - [x] 8.2 Write property test for HUD font specification
    - **Property 33: HUD Font Specification**
    - **Validates: Requirements 6.3**
  
  - [x] 8.3 Write property test for score visibility
  ...
  - [x] 8.6 Write property test for game over display
...
- [x] 9. Implement BootScene
  ...
  - [x] 9.2 Write unit test for BootScene
    - Test logo loading
...
- [x] 10. Implement PreloaderScene
  ...
  - [x] 10.2 Write unit test for PreloaderScene
    - Test asset loading
...
- [x] 12. Implement GameScene core structure
  - [x] 12.1 Create GameScene.js with constructor and properties
    ...
    - _Requirements: 1.1, 1.6, 2.3, 6.1_
  ...
  - [x] 12.3 Implement create() method
    ...
    - Create HUD
    - _Requirements: 1.1, 5.5, 6.1, 12.4_
  
  - [x] 12.4 Write property test for Game_World background color
    - **Property 32: Game World Background Color**
    - **Validates: Requirements 5.5**
  
  - [x] 12.5 Write unit test for initial game state
...
- [x] 13. Implement GameScene game loop
  ...
  - [x] 13.2 Write property test for continuous movement
  ...
  - [x] 13.3 Implement checkCollisions() method
    ...
    - _Requirements: 3.1, 3.2, 10.4, 12.1, 12.2_
  
  - [x] 13.4 Write property test for pop sound on consumption
    - **Property 24: Pop Sound on Consumption**
    - **Validates: Requirements 12.1**
  
  - [x] 13.5 Write property test for explosion sound on death
  ...
  - [x] 13.7 Write property test for bubble count invariant
  ...
  - [x] 13.9 Write property test for bubble radius rendering
...
- [x] 14. Implement GameScene state transitions
  - [x] 14.1 Implement handleDeath() method
    ...
    - _Requirements: 1.2, 1.6, 3.3, 4.6, 12.3_
  
  - [x] 14.2 Write property test for life decrement
    - **Property 9: Life Decrement**
    - **Validates: Requirements 1.2**
  
  - [x] 14.3 Write property test for fanfare sound on reset
    - **Property 26: Fanfare Sound on Level Reset**
    - **Validates: Requirements 12.3**
  
  - [x] 14.4 Write property test for progressive bubble count
  ...
  - [x] 14.5 Implement handleWin() method
    ...
    - _Requirements: 1.4, 1.6, 4.6, 12.3_
  
  - [x] 14.6 Write property test for win condition reset
  ...
  - [x] 14.7 Implement restartScenarioWithPause() method
    ...
    - After delay: set isPaused to false, reset player bubble size to 30, restart scene
    - _Requirements: 1.6, 1.7_
  
  - [x] 14.8 Write property test for scenario restart pause duration
    - **Property 29: Scenario Restart Pause Duration**
    - **Validates: Requirements 1.6**
  
  - [x] 14.9 Write property test for player size reset on restart
    - **Property 30: Player Size Reset on Scenario Restart**
    - **Validates: Requirements 1.7**
  
  - [x] 14.10 Implement handleGameOver() method
    - Pause scene
...
- [x] 15. Implement GameScene input handling
  ...
  - [x] 15.2 Write property test for input coordinate normalization
...
- [x] 17. Create main.js and wire everything together
  - [x] 17.1 Create main.js with Phaser configuration
    ...
    - _Requirements: 2.3, 5.4, 9.1_
  
  - [x] 17.2 Write property test for screen background color
    - **Property 31: Screen Background Color**
    - **Validates: Requirements 5.4**
  
  - [x] 17.3 Write integration test for scene flow
...
- [x] 18. Implement PWA features
  ...
  - [x] 18.2 Write unit test for service worker
    - Test cache storage
  ...
  - [x] 18.4 Write unit test for PWA configuration
...
- [x] 20. Final integration and testing
  - [x] 20.1 Test complete game flow
    ...
    - _Requirements: 1.1, 1.2, 1.3, 1.4, 1.6, 1.7, 3.2, 3.3, 3.4, 4.2, 4.6, 5.4, 5.5, 6.3_
  
  - [x] 20.2 Run all property tests with extended iterations
    - Run all 33 property tests with 1000 iterations each
  
  - [x] 20.3 Test PWA installation and offline functionality
    - Verify game can be installed
    - Verify game works offline after installation
    - _Requirements: 7.3, 7.4_
  
  - [x] 20.4 Test cross-device compatibility
...
- All 33 correctness properties from the design document are covered by property test tasks
- PWA features are implemented last to ensure core game functionality is solid first
- New specifications include: dark gray screen background (#808080), black Game_World background (#000000), 24pt font for HUD, 200px AI spawn distance from player, 2-second pause on scenario restart, and player size reset to 30 pixels after pause
